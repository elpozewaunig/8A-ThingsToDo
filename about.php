...
<div class="content-block">
  <p>This website was developed by Elias Pozewaunig to help students of class 6A manage their assignments. Several amazing people helped me accomplish this project - <a href="thanks.php">check them out</a>! <br>
  Just in case you are interested in the code - it is available under the <a href="https://github.com/elpozewaunig/6A-ThingsToDo/blob/master/LICENSE" target="_blank">MIT license</a> on <a href="https://github.com/elpozewaunig/6A-ThingsToDo" target="_blank">GitHub</a>.</p>
